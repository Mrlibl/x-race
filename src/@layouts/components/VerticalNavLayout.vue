...
<template>
  <div class="layout-wrapper" :class="configStore._layoutClasses">
    ...
    <div class="layout-content-wrapper">
      ...
      <!-- <div class="custom-full-width-bar" /> -->
...
.layout-wrapper.layout-nav-type-vertical {
  ...
  .layout-content-wrapper {
    ...
    // transition: padding-inline-end 0.2s ease-in-out;
    will-change: padding-inline-start;

    @media screen and (min-width: 1280px) {
      padding-inline-start: variables.$layout-vertical-nav-width;
      // padding-inline-end: variables.$layout-vertical-nav-width;
    }
  }
  ...
  .layout-navbar {
    ...
    // box-shadow: 0 4px 8px -4px rgba(var(--v-shadow-key-umbra-color), 0.8);
...
.custom-full-width-bar {
  width: 100%;
  height: 64px; // 自定义你需要的高度
  background-color: rgb(var(--v-theme-041B39));
  position: absolute;
}
